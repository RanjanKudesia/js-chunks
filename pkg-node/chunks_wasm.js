...
exports.RtfDocument = RtfDocument;
 ...
 * @returns {any}
 */
function chunkPdfMarkdown(markdown, total_pages, mode, window_size, overlap, sentences_per_chunk, paragraphs_per_page) {
...
exports.chunkPdfMarkdown = chunkPdfMarkdown;
 ...
 * @returns {any}
 */
function chunkPdfMarkdownWithImages(markdown, images, total_pages, mode, window_size, overlap, sentences_per_chunk, paragraphs_per_page) {
    const ptr0 = passStringToWasm0(markdown, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(mode, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.chunkPdfMarkdownWithImages = chunkPdfMarkdownWithImages;
 ...
 * @returns {any}
 */
function getChunks(data, filename, mode, window_size, overlap, sentences_per_chunk, paragraphs_per_page) {
 ...
 * @returns {any}
 */
function getChunksWithImages(data, filename, mode, window_size, overlap, sentences_per_chunk, paragraphs_per_page) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(filename, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.getChunksWithImages = getChunksWithImages;
 ...
 * @returns {string}
 */
function getMarkdown(data, filename) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
 ...
 * @returns {any}
 */
function getMarkdownWithImages(data, filename) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(filename, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.getMarkdownWithImages = getMarkdownWithImages;
 ...
 * @returns {string}
 */
function normalizePdfMarkdown(markdown) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(markdown, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
exports.normalizePdfMarkdown = normalizePdfMarkdown;

/**
 * @param {string} rtf
 * @returns {RtfDocument}
 */
function parse_rtf(rtf) {
...
const wasmPath = `${__dirname}/chunks_wasm_bg.wasm`;
